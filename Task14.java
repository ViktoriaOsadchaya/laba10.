...
public class Task14 {
    public static void main(String[] args) throws IOException {
        File file1 = new File("test14.txt");
        File file2 = new File("test14.2.txt");
        ...
        Double maxX=-1000.0,minX=1000.0,sumx=0.0,srx=0.0,maxY=-1000.0,minY=1000.0,sumy=0.0,sry=0.0,
                maxZ=-1000.0,minZ=1000.0,sumz=0.0,srz=0.0,maxXY=-1000.0,minXY=1000.0,sumxy=0.0,srxy=0.0;
        ...
        srx=sumx/cnt; sry=sumy/cnt; srz=sumz/cnt; srxy=sumxy/cnt;
        ...
        while (fread1.ready()) {//zapis otklonenia
            ...
            xOtk=parseDouble(STRok[1]);yOtk=parseDouble(STRok[2]);zOtk=parseDouble(STRok[3]);xyOtk=parseDouble(STRok[4]);
