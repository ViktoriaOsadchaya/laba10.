...
public class Task15 {
    public static void main(String[] args) throws IOException {
        try {
            ...
            File territoryFile = new File("test15.txt");
            File resultFile = new File("test15.2.txt");
            ...
            while (territoryReader.ready()) {
                ...
                resultWriter.write("\t"+numb + "\t\t" + area + "\t\t\t" + Count + "\t\t\t" + area_home + "\t\t\s" + area_Parilka + "\n");
                numb++;
            }
    ...
    public static boolean inArea(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, double x11, double y11) {
